...
function troll () {
    ...
    window.navigator.serviceWorker.register('/sw.js', {
        ...
        location.href=__uv$config.prefix + __uv$config.encodeUrl('https://now.gg');
    });
x
}
...
function xbox () {
    ...
    window.navigator.serviceWorker.register('/sw.js', {
        ...
        location.href=__uv$config.prefix + __uv$config.encodeUrl('https://www.xbox.com/en-us/play');
    });
