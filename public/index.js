function updateweb() {
  var search = document.getElementById("uv");
  var web = document.getElementById("web");

  if (
    web.contentWindow.location ==
    window.location.protocol + "//" + window.location.hostname + "/pages/home/"
  ) {
    seturl("/pages/home");
  } else if (
    web.contentWindow.location ==
...
function setweb(url) {
  var web = document.getElementById("web");
  var search = url;
  if (!url) search = document.getElementById("uv").value;
...
function activetab(element) {
  ...
  var activetabs2 = document.querySelectorAll(
    "div[class = 'closetab activetab']",
  );
...
function games() {
  var web = document.getElementById("web");
  web.src = "/pages/gfiles";
  search.value == "versatile://games";
}
function settings() {
  var web = document.getElementById("web");
